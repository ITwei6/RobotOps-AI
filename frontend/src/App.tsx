...
function normalizeReport(raw: Partial<Report>): Report {
  return {
    ...
    execution_chain: raw.execution_chain ?? ["Bug 单已创建", "Agent 已执行诊断", "报告已保存"],
